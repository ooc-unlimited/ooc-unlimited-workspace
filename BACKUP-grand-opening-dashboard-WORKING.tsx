  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/grand-opening/new" className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-lg font-semibold transition-colors">
          + New Grand Opening
        </Link>
      </div>
      ...
      {events.length === 0 ? (
        <div className="text-center py-20 bg-[#111] border border-[#262626] rounded-xl">
          ...
          <Link href="/admin/grand-opening/new" className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-lg font-semibold">
        ...
        <div className="grid gap-4">
          {events.map(e => (
            <Link key={e.id} href={`/admin/grand-opening/${e.id}`} className="block bg-[#111] border border-[#262626] rounded-xl p-6 hover:border-indigo-500/50 transition-colors">
              <div className="flex items-center justify-between">
                <div>
